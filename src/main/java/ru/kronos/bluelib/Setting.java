...
public enum Setting {
	...
	OnlineEngine_enabled(true),
	CooldownEngine_enabled(true),
	RequestEngine_enabled(true),
	WarmUpEngine_enabled(true),
	EventEngine_enabled(true),
	EnchantEngine_enabled(true),
	PotionEngine_enabled(true),
	DamageControlEngine_enabled(true),
	DamageControlEngine_enableTimings(false),
	DamageControlEngine_HealthOverDamage_enable(false),
	DamageControlEngine_HealthOverDamage_hitCooldownMillis(400),
	DamageControlEngine_HealthOverDamage_hitCounter(3),
	DamageControlEngine_dealDamageFrequencyTicks(10),
	CommandEngine_enabled(true),
	ChestMenuEngine_enabled(true),
	ScoreboardEngine_enabled(true),
	StorageEngine_enabled(true),
	StorageEngine_timeBeforeFlush(60L),
	StorageEngine_saveEverySeconds(5L),
	PluginEngine_enabled(true),
	
	CooldownEngine_clearTaskDelaySeconds(30L),
	RequestEngine_clearTaskDelaySeconds(30L),
	WarmUpEngine_countingPattern("60,30,10,5-1"),


	API3rdPartyEngine_DiscordSRV(false),
	API3rdPartyEngine_PlaceholderAPI(false),
	API3rdPartyEngine_PermissionEx(false),
	API3rdPartyEngine_LuckyPerms(false);
