...
public enum Setting {
	...
	line1("{c}{display}&7: {value}"),
	line2("{c}{display}&7: {sign}{value}%"),
	talismanLine("&eТалисман {number}&7: &8[{talismanName}&8]"),
	talismanEmptyLine("&eТалисман &8{number}/{all}&7: &8[пусто]"),
	undroppable("{c}{display}"),
	effectsApplyEveryTicks(10L),
	syncPlayerTaskDelay(10L),
